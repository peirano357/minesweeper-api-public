...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //*** BEGIN - Controllers added for GAME
        'accountCtrl': 'assets/js/controllers/accountCtrl.js',
        'gameCtrl': 'assets/js/controllers/gameCtrl.js',
        'accountFactory': 'assets/js/factories/account.js',
        'gameSessionFactory': 'assets/js/factories/gamesession.js',
        //*** END Controllers added for GAME 
